...
# 加载表1和表2
best_solutions = pd.read_csv('density_best_solutions.csv')
...
# 保存匹配结果到新表
best_solutions[['Matched_Solvent_Type', 'Matched_Metal_Type', 'Matched_Descriptor']].to_csv('density_matched_results.csv', index=False)
