...
plt.savefig('densityM+L+S.png', dpi=300)
plt.show()
...
plt.savefig('shap_feature_importance_Density_M+L+S.png', dpi=600)  # 更高的分辨率
plt.show()

# 绘制SHAP值的汇总图，控制最大显示的特征数量
plt.figure(figsize=(6, 6))  # 更大的图像尺寸
shap.summary_plot(shap_values, X_train, show=False, max_display=12)  # 显示前15个重要特征
plt.savefig('shap_Density_M+L+S.png', dpi=600)  # 更高的分辨率
plt.show()